...
@section('content')
    ...
    <script>
        function selectAllPermissions() {
            document.querySelectorAll('.permission-checkbox:not([disabled])').forEach(checkbox => checkbox.checked = true);
        }

        function deselectAllPermissions() {
            document.querySelectorAll('.permission-checkbox:not([disabled])').forEach(checkbox => checkbox.checked = false);
        }

        function toggleGroupPermissions(group, state) {
            document.querySelectorAll(`.permission-checkbox[data-group="${group}"]:not([disabled])`)
